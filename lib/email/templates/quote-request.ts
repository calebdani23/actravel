...
function model(context: QuoteEmailContext): ViewModel {
  ...
  return {
    ...
    adminWhatsAppHref: context.adminWhatsAppHref,
    clientWhatsAppHref: context.clientWhatsAppHref,
  };
}
...
function renderAdminQuoteEmail(vm: ViewModel) {
  ...
  const content = renderShell({
    ...
    primaryCta: { label: label.contactWhatsApp, href: vm.adminWhatsAppHref },
...
function renderClientQuoteEmail(vm: ViewModel) {
  ...
  const content = renderShell({
    ...
    primaryCta: { label: label.continueWhatsApp, href: vm.clientWhatsAppHref },
