...
export type Database = {
  public: {
    Tables: {
      ...
      packages: Table<BilingualCatalogRow & { price_from_mxn: number | null; price_from_usd: number | null; sort_order: number; hero_image_url: string | null; thumbnail_image_url: string | null }>;
