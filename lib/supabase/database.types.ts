...
export type Database = {
  public: {
    Tables: {
      ...
      destinations: Table<BilingualCatalogRow & { country: string; region: string | null; hero_image_url: string | null }>;
      services: Table<BilingualCatalogRow & { price_from_mxn: number | null; price_from_usd: number | null; sort_order: number }>;
      promotions: Table<TimestampedRow & { destination_id: string | null; service_id: string | null; title_es: string; title_en: string; slug_es: string; slug_en: string; summary_es: string | null; summary_en: string | null; details_es: string | null; details_en: string | null; price_from_mxn: number | null; price_from_usd: number | null; starts_at: string | null; ends_at: string | null; is_featured: boolean; status: string; published_at: string | null }>;
      ...
      message_templates: Table<TimestampedRow & { name: string; channel: string; subject_es: string | null; subject_en: string | null; body_es: string; body_en: string; variables: Json; is_active: boolean }>;
      ...
      notification_logs: Table<BaseRow & { lead_id: string | null; contact_id: string | null; channel: string; provider: string | null; recipient: string | null; template_name: string | null; status: string; error_message: string | null; payload: Json; provider_message_id: string | null; sent_at: string | null; updated_at: string }>;
      sheet_sync_logs: Table<BaseRow & { lead_id: string | null; direction: string; sheet_name: string | null; row_id: string | null; status: string; error_message: string | null; payload: Json }>;
    };
