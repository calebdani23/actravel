...
export default async function Page({ params, searchParams }: { params: Promise<{ locale: Locale }>; searchParams: Promise<SearchParams> }) { const { locale } = await params; assertRouteLocale(locale, "en"); return <QuotePage locale={locale} initialContext={initialContext(await searchParams)} />; }
